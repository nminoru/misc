...
-- 
CREATE OR ALTER FUNCTION query80(@SALESDATE date)
RETURNS TABLE
AS
RETURN
(
...
WITH ssr AS (
    ...
    WHERE
        ...
        AND d_date BETWEEN @SALESDATE AND DATEADD(day, +30, @SALESDATE)
...
FROM
    day_series
    CROSS APPLY (SELECT * FROM query80(day_series.day)) body;
