...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-04-12','2001-09-24','2001-11-18')))
...
and d_date between '2002-01-29' and 
        (dateadd(day, +90, cast('2002-01-29' as date)))
...
where 
	...
	and d_date between cast('1998-05-07' as date) 
				and (dateadd(day, +30, cast('1998-05-07' as date)))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-03' as date) 
                  and (dateadd(day, +30, cast('2000-08-03' as date))) 
...
select top 100 
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2000-05-30' as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (dateadd(day, -30, cast ('2000-05-30' as date)))
                and (dateadd(day, +30, cast ('2000-05-30' as date))) 
 group by
    w_state,i_item_id
...
where 
	...
	and d_date between cast('2002-05-13' as date) 
				and (dateadd(day, +30, cast('2002-05-13' as date)))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with  cross_items as
 ...
 where ws_item_sk = iws.i_item_sk
   ...
   and d3.d_year between 1999 AND 1999 + 2) dummy1
...
select top 100 i_item_id
 ...
 and d_date between cast('1998-07-03' as date) and (dateadd(day, +60, cast('1998-07-03' as date)))
...
select top 100 i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-03-30' as date) and (dateadd(day, +60, cast('2000-03-30' as date)))
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-25' as date) 
                  and (dateadd(day, +30, cast('1998-08-25' as date)))
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select top 100 *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (dateadd(day, -30, cast ('1999-04-18' as date)))
                    and (dateadd(day, +30, cast ('1999-04-18' as date)))
...
select top 100 i_item_id
 ...
 and d_date between cast('2001-03-29' as date) 
 				and (dateadd(day, +30, cast('2001-03-29' as date)))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
