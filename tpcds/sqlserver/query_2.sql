...
where 
	...
	and d_date between cast('1999-05-25' as date) 
				and (dateadd(day, +30, cast('1999-05-25' as date)))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-11' as date) 
                  and (dateadd(day, +14, cast('2001-08-11' as date)))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-07-21','1998-09-26','1998-11-21')))
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-12' as date) 
                  and (dateadd(day, +30, cast('2000-08-12' as date)))
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-17' as date) 
                  and (dateadd(day, +30, cast('2002-08-17' as date))) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select top 100 *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('1999-05-04' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (dateadd(day, -30, cast ('1999-05-04' as date)))
...
select top 100 i_item_id
 ...
 and d_date between cast('2002-01-20' as date) and (dateadd(day, +60, cast('2002-01-20' as date)))
...
select top 100 
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2001-02-24' as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (dateadd(day, -30, cast ('2001-02-24' as date)))
                and (dateadd(day, +30, cast ('2001-02-24' as date))) 
 group by
    w_state,i_item_id
...
select top 100 i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-03-22' as date) and (dateadd(day, +60, cast('2002-03-22' as date)))
...
where 
	...
	and d_date between cast('2001-06-05' as date) 
				and (dateadd(day, +30, cast('2001-06-05' as date)))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select top 100 i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('2001-04-06' as date) 
 				and (dateadd(day, +30, cast('2001-04-06' as date)))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
and d_date between '1998-01-17' and 
        (dateadd(day, +90, cast('1998-01-17' as date)))
...
i_manufact_id = 21
and i_item_sk = ws_item_sk 
and d_date between '1998-03-24' and 
        (dateadd(day, +90, cast('1998-03-24' as date)))
