-- start query 1 in stream 9 using template query15.tpl
...
-- start query 2 in stream 9 using template query60.tpl
with ss as (
 select
...
-- start query 3 in stream 9 using template query62.tpl
select top 100 
...
-- start query 4 in stream 9 using template query74.tpl
with year_total as (
...
-- start query 5 in stream 9 using template query81.tpl
...
-- start query 6 in stream 9 using template query88.tpl
select  *
from
...
-- start query 7 in stream 9 using template query50.tpl
select top 100 
   s_store_name
  ,s_company_id
  ,s_street_number
...
-- start query 8 in stream 9 using template query5.tpl
with ssr as
 (select s_store_id,
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-08' as date) 
                  and (dateadd(day, +14, cast('2002-08-08' as date)))
...
-- end query 8 in stream 9 using template query5.tpl
-- start query 9 in stream 9 using template query84.tpl
select top 100 c_customer_id as customer_id
 ...
 where ca_city	        =  'Union'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  19344
   and ib_upper_bound   <=  19344 + 50000
...
-- start query 10 in stream 9 using template query1.tpl
with customer_total_return as
...
-- start query 11 in stream 9 using template query52.tpl
...
-- start query 12 in stream 9 using template query57.tpl
with v1 as(
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('VA', 'FL', 'IA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OR', 'ND', 'AZ')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'SC', 'MO')
  and ss_net_profit between 50 and 250  
     ))
;

-- end query 13 in stream 9 using template query13.tpl
-- start query 14 in stream 9 using template query14.tpl
with  cross_items as
...
-- end query 14 in stream 9 using template query14.tpl
-- start query 15 in stream 9 using template query90.tpl
...
-- start query 16 in stream 9 using template query7.tpl
...
-- start query 17 in stream 9 using template query27.tpl
select top 100 i_item_id,
...
-- end query 17 in stream 9 using template query27.tpl
-- start query 18 in stream 9 using template query92.tpl
select top 100 
...
and d_date between '1998-02-01' and 
        (dateadd(day, +90, cast('1998-02-01' as date)))
...
-- start query 19 in stream 9 using template query39.tpl
with inv as
...
-- start query 20 in stream 9 using template query34.tpl
select c_last_name
       ,c_first_name
       ,c_salutation
...
select top 100 *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('1999-04-03' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (dateadd(day, -30, cast ('1999-04-03' as date)))
                    and (dateadd(day, +30, cast ('1999-04-03' as date)))
...
-- start query 22 in stream 9 using template query65.tpl
select top 100
	s_store_name,
	i_item_desc,
	sc.revenue,
...
-- start query 23 in stream 9 using template query75.tpl
WITH all_sales AS (
 SELECT d_year
       ,i_brand_id
       ,i_class_id
...
-- start query 24 in stream 9 using template query9.tpl
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 38360
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 36688
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 45177
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 28778
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 10124
            then (select avg(ss_ext_list_price)
                  from store_sales
...
-- start query 25 in stream 9 using template query2.tpl
with wscs as
 (select sold_date_sk
        ,sales_price
...
-- start query 26 in stream 9 using template query12.tpl
select top 100 i_item_id
      ,i_item_desc 
      ,i_category 
      ,i_class 
...
where 
	...
	and d_date between cast('2001-01-26' as date) 
				and (dateadd(day, +30, cast('2001-01-26' as date)))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
-- start query 27 in stream 9 using template query32.tpl
...
and d_date between '1998-02-17' and 
        (dateadd(day, +90, cast('1998-02-17' as date)))
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 98 and 98+10
          or ss_coupon_amt between 1938 and 1938+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 103 and 103+10
          or ss_coupon_amt between 11014 and 11014+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 127 and 127+10
          or ss_coupon_amt between 5708 and 5708+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 176 and 176+10
          or ss_coupon_amt between 9696 and 9696+1000
          or ss_wholesale_cost between 58 and 58+20)) B6
;

-- end query 28 in stream 9 using template query28.tpl
-- start query 29 in stream 9 using template query42.tpl
select top 100 dt.d_year
 	,item.i_category_id
 	,item.i_category
...
-- start query 30 in stream 9 using template query17.tpl
select top 100 i_item_id
       ,i_item_desc
       ,s_state
...
-- start query 31 in stream 9 using template query67.tpl
select top 100 *
...
-- end query 31 in stream 9 using template query67.tpl
-- start query 32 in stream 9 using template query31.tpl
with ss as
...
-- start query 33 in stream 9 using template query20.tpl
select top 100 i_item_id
       ,i_item_desc 
       ,i_category 
       ,i_class 
 ...
 where cs_item_sk = i_item_sk 
   and i_category in ('Home', 'Shoes', 'Men')
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('2000-02-27' as date) 
 				and (dateadd(day, +30, cast('2000-02-27' as date)))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
-- start query 34 in stream 9 using template query11.tpl
with year_total as (
 select c_customer_id customer_id
       ,c_first_name customer_first_name
       ,c_last_name customer_last_name
...
-- start query 35 in stream 9 using template query77.tpl
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-25' as date) 
                  and (dateadd(day, +30, cast('1999-08-25' as date))) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
-- end query 35 in stream 9 using template query77.tpl
-- start query 36 in stream 9 using template query36.tpl
select top 100 * from (
 select
...
-- end query 36 in stream 9 using template query36.tpl
-- start query 37 in stream 9 using template query82.tpl
select top 100 i_item_id
       ,i_item_desc
       ,i_current_price
 ...
 and d_date between cast('1999-02-06' as date) and (dateadd(day, +60, cast('1999-02-06' as date)))
 and i_manufact_id in (269,70,900,230)
...
-- start query 38 in stream 9 using template query33.tpl
with ss as (
 select
...
-- start query 39 in stream 9 using template query54.tpl
...
-- start query 40 in stream 9 using template query4.tpl
with year_total as (
 select c_customer_id customer_id
       ,c_first_name customer_first_name
       ,c_last_name customer_last_name
...
-- start query 41 in stream 9 using template query16.tpl
select top 100 
...
-- start query 42 in stream 9 using template query10.tpl
select top 100 
  cd_gender,
  cd_marital_status,
  cd_education_status,
 ...
 where
  ...
  ca_county in ('Hall County','Madison County','Cavalier County','Parke County','Harrison County') and
...
-- start query 43 in stream 9 using template query18.tpl
select top 100 i_item_id,
        ca_country,
        ca_state, 
        ca_county,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (10,2,8,11,4,12) and
       d_year = 2000 and
       ca_state in ('MN','OK','OH'
                   ,'GA','WI','IA','ND')
...
-- end query 43 in stream 9 using template query18.tpl
...
-- start query 45 in stream 9 using template query24.tpl
with ssales as
(select c_last_name
      ,c_first_name
      ,s_store_name
...
-- start query 46 in stream 9 using template query30.tpl
with customer_total_return as
...
-- start query 47 in stream 9 using template query78.tpl
with ws as
...
-- start query 48 in stream 9 using template query6.tpl
...
-- start query 49 in stream 9 using template query80.tpl
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-05' as date) 
                  and (dateadd(day, +30, cast('1999-08-05' as date)))
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
-- end query 49 in stream 9 using template query80.tpl
-- start query 50 in stream 9 using template query35.tpl
select top 100  
  ca_state,
  cd_gender,
  cd_marital_status,
...
-- start query 51 in stream 9 using template query59.tpl
with wss as 
 (select d_week_seq,
        ss_store_sk,
...
-- start query 52 in stream 9 using template query99.tpl
select top 100 
   substring(w_warehouse_name,1,20)
  ,sm_type
  ,cc_name
...
-- start query 53 in stream 9 using template query61.tpl
...
-- start query 54 in stream 9 using template query22.tpl
...
-- start query 55 in stream 9 using template query71.tpl
...
-- start query 56 in stream 9 using template query68.tpl
...
-- start query 57 in stream 9 using template query40.tpl
select top 100 
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2001-03-17' as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (dateadd(day, -30, cast ('2001-03-17' as date)))
...
-- start query 58 in stream 9 using template query66.tpl
select top 100  
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 33791 and 33791+28800 
...
-- start query 59 in stream 9 using template query94.tpl
select top 100 
...
-- start query 60 in stream 9 using template query47.tpl
with v1 as(
 select i_category, i_brand,
...
-- start query 61 in stream 9 using template query26.tpl
select top 100 i_item_id, 
...
-- start query 62 in stream 9 using template query25.tpl
select top 100 
 i_item_id
 ,i_item_desc
 ,s_store_id
...
-- start query 63 in stream 9 using template query98.tpl
select i_item_id
      ,i_item_desc 
      ,i_category 
      ,i_class 
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast('2001-01-29' as date) 
				and (dateadd(day, +30, cast('2001-01-29' as date)))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
-- start query 64 in stream 9 using template query70.tpl
select top 100 * from (
 select 
...
-- end query 64 in stream 9 using template query70.tpl
-- start query 65 in stream 9 using template query73.tpl
select c_last_name
       ,c_first_name
       ,c_salutation
       ,c_preferred_cust_flag 
...
-- start query 66 in stream 9 using template query38.tpl
...
-- start query 67 in stream 9 using template query87.tpl
select count(*) 
...
-- start query 68 in stream 9 using template query3.tpl
select top 100 dt.d_year 
       ,item.i_brand_id brand_id 
       ,item.i_brand brand
...
-- start query 70 in stream 9 using template query86.tpl
select top 100 * from (
 select 
...
-- end query 70 in stream 9 using template query86.tpl
-- start query 71 in stream 9 using template query79.tpl
select top 100
...
-- start query 72 in stream 9 using template query89.tpl
select top 100 *
from(
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (2002) and
        ((i_category in ('Shoes','Home','Women') and
          i_class in ('athletic','paint','dresses')
         )
      or (i_category in ('Men','Jewelry','Sports') and
          i_class in ('shirts','mens watch','baseball') 
        ))
...
-- start query 73 in stream 9 using template query51.tpl
WITH web_v1 as (
select
...
-- start query 74 in stream 9 using template query58.tpl
with ss_items as
...
-- start query 75 in stream 9 using template query41.tpl
select top 100 i_product_name
 from item i1
 where i_manufact_id between 929 and 929+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'orange' or i_color = 'pale') and
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'grey' or i_color = 'lawn') and
...
-- start query 76 in stream 9 using template query19.tpl
...
-- start query 77 in stream 9 using template query83.tpl
with sr_items as
 (select i_item_id item_id,
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-01-02','2002-08-05','2002-11-13')))
...
-- start query 78 in stream 9 using template query96.tpl
...
-- start query 79 in stream 9 using template query46.tpl
select top 100 c_last_name
       ,c_first_name
       ,ca_city
       ,bought_city
...
-- start query 80 in stream 9 using template query53.tpl
select top 100 * from 
...
-- start query 81 in stream 9 using template query55.tpl
...
-- start query 82 in stream 9 using template query72.tpl
...
-- start query 83 in stream 9 using template query95.tpl
with ws_wh as
...
-- start query 84 in stream 9 using template query29.tpl
select top 100  
     i_item_id
    ,i_item_desc
    ,s_store_id
...
-- start query 85 in stream 9 using template query64.tpl
with cs_ui as
 (select cs_item_sk
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('light','cyan','hot','rosy','ivory','blanched') and
...
-- start query 86 in stream 9 using template query93.tpl
...
-- start query 87 in stream 9 using template query56.tpl
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('moccasin','grey','metallic'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 3
...
-- start query 88 in stream 9 using template query97.tpl
with ssci as (
...
-- start query 89 in stream 9 using template query23.tpl
...
-- start query 90 in stream 9 using template query44.tpl
...
-- start query 92 in stream 9 using template query49.tpl
...
-- start query 93 in stream 9 using template query76.tpl
...
-- start query 94 in stream 9 using template query63.tpl
select top 100 * 
...
-- start query 95 in stream 9 using template query45.tpl
...
-- start query 96 in stream 9 using template query43.tpl
...
-- start query 97 in stream 9 using template query85.tpl
...
-- start query 98 in stream 9 using template query37.tpl
select top 100 i_item_id
       ,i_item_desc
       ,i_current_price
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-02-20' as date) and (dateadd(day, +60, cast('2002-02-20' as date)))
 and i_manufact_id in (816,710,872,876)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
-- start query 99 in stream 9 using template query8.tpl
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '62501','61688','20074','88195','23878','50665',
                          '11041','10822','33476','39581','34208',
                          '82254','66160','29261','15621','70283',
                          '69987','12302','93114','26353','79762',
                          '86660','96416','14535','18266','51737',
                          '78351','65862','69616','95553','66695',
                          '37615','79975','73783','89652','64052',
                          '15271','29441','73450','57386','17713',
                          '96898','51045','86148','56111','55015',
                          '54676','72388','85600','32267','82321',
                          '91317','24914','40837','73788','17040',
                          '25934','29666','33244','53954','30186',
                          '70341','78737','47666','93935','66416',
                          '39152','91462','92464','85018','91232',
                          '15811','99884','31010','34799','88227',
                          '48681','88358','59620','76050','52310',
                          '46339','53987','45745','94174','21596',
                          '78796','98038','99246','69589','32054',
                          '21540','79929','89178','77587','80795',
                          '72632','47139','30455','50349','54788',
                          '38147','77473','69295','85436','99614',
                          '36328','98301','97972','98243','73973',
                          '35822','81509','55589','49861','14494',
                          '50315','54182','69218','57599','94180',
                          '91526','10138','41504','15147','21251',
                          '49082','59883','74426','53111','52785',
                          '66012','53610','16333','92037','79742',
                          '80875','63837','92055','34070','21099',
                          '71789','59751','24201','12064','37396',
                          '96192','19835','51824','70181','43161',
                          '99964','32900','45897','79840','12309',
                          '83947','80007','65557','30286','25567',
                          '75533','49395','32063','10313','20672',
                          '86160','61161','28540','83071','76777',
                          '16582','51380','53575','43349','92155',
                          '44425','58669','35610','86909','19075',
                          '95004','15131','15787','35793','54756',
                          '51627','74302','74987','67674','36357',
                          '38978','63877','55439','45152','16032',
                          '85030','34037','32113','14971','79002',
                          '94110','44666','50171','44677','73550',
                          '82274','25539','48382','40634','39870',
                          '52748','77353','29061','64210','68149',
                          '10027','49203','95121','69636','16885',
                          '64657','77053','33410','97552','96308',
                          '76599','13534','25739','94852','47536',
                          '11968','71271','20248','88766','96558',
                          '96830','50280','19479','54797','62154',
                          '15081','63736','48994','48346','40416',
                          '62339','24329','32418','14395','71529',
                          '73515','68364','74790','68809','81799',
                          '68677','76488','41240','60961','71848',
                          '78338','18494','56243','10806','38256',
                          '98787','53333','83239','33574','25913',
                          '96076','17285','38812','34838','40922',
                          '70740','76893','88746','51826','20348',
                          '28207','49767','17169','94736','88562',
                          '61425','48552','66460','30328','99251',
                          '72009','32195','27642','19116','92400',
                          '52609','53795','83974','84636','13459',
                          '12810','79488','41931','22160','69279',
                          '97479','36852','69611','88047','68579',
                          '27657','98816','24216','92586','41664',
                          '96713','75284','91961','64717','28472',
                          '82867','29795','39852','53339','47818',
                          '86950','28916','32407','42285','62096',
                          '90305','65328','15699','75201','93157',
                          '99263','44172','35721','14919','12156',
                          '62010','46311','38563','59255','84246',
                          '24680','41008','55854','10959','53614',
                          '14032','38426','87600','66970','39793',
                          '48288','21928','65575','62346','26784',
                          '45183','45521','60997','98112','48802',
                          '73069','60594','62324','63100','41394',
                          '14187','18497','75310','88050','17003',
                          '64946','22368','64617','23361','50515',
                          '47317','13823','21243','87762','63911',
                          '81083','23155','91446','72138','70715',
                          '13194','35275','46342','27233','91459',
                          '69955','75902','70627','99858')
     intersect
      select ca_zip
