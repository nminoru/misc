...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-12' as date) 
                  and (dateadd(day, +14, cast('2002-08-12' as date)))
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-10' as date) 
                  and (dateadd(day, +30, cast('1999-08-10' as date)))
...
select top 100 i_item_id
 ...
 and d_date between cast('1999-05-26' as date) and (dateadd(day, +60, cast('1999-05-26' as date)))
...
select top 100 *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (dateadd(day, -30, cast ('2000-04-16' as date)))
                    and (dateadd(day, +30, cast ('2000-04-16' as date)))
...
select top 100 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (dateadd(day, -30, cast ('1999-06-03' as date)))
                and (dateadd(day, +30, cast ('1999-06-03' as date))) 
 group by
    w_state,i_item_id
...
and d_date between '2002-03-13' and 
        (dateadd(day, +90, cast('2002-03-13' as date)))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-06-05','1999-10-03','1999-11-18')))
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('2002-06-04' as date) 
				and (dateadd(day, +30, cast('2002-06-04' as date)))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and d_date between '2000-03-03' and 
        (dateadd(day, +90, cast('2000-03-03' as date)))
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast('2000-02-24' as date) 
				and (dateadd(day, +30, cast('2000-02-24' as date)))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-05' as date) 
                  and (dateadd(day, +30, cast('2000-08-05' as date))) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select top 100 i_item_id
 ...
 and d_date between cast('1998-04-05' as date) 
 				and (dateadd(day, +30, cast('1998-04-05' as date)))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
