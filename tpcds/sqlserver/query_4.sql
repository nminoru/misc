-- start query 1 in stream 4 using template query79.tpl
select top 100
...
-- end query 1 in stream 4 using template query79.tpl
-- start query 2 in stream 4 using template query39.tpl
with inv as
...
-- end query 2 in stream 4 using template query39.tpl
-- start query 3 in stream 4 using template query93.tpl
...
-- end query 3 in stream 4 using template query93.tpl
...
-- start query 5 in stream 4 using template query29.tpl
select top 100  
     i_item_id
    ,i_item_desc
    ,s_store_id
...
-- end query 5 in stream 4 using template query29.tpl
-- start query 6 in stream 4 using template query32.tpl
...
and d_date between '2002-02-25' and 
        (dateadd(day, +90, cast('2002-02-25' as date)))
...
-- start query 7 in stream 4 using template query66.tpl
select top 100  
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 48380 and 48380+28800 
...
-- end query 7 in stream 4 using template query66.tpl
-- start query 8 in stream 4 using template query84.tpl
select top 100 c_customer_id as customer_id
 ...
 where ca_city	        =  'Valley View'
   ...
   and ib_lower_bound   >=  68836
   and ib_upper_bound   <=  68836 + 50000
...
-- start query 10 in stream 4 using template query71.tpl
...
-- end query 10 in stream 4 using template query71.tpl
-- start query 11 in stream 4 using template query45.tpl
...
-- end query 11 in stream 4 using template query45.tpl
-- start query 12 in stream 4 using template query89.tpl
select top 100 *
from(
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Electronics','Shoes','Music') and
          i_class in ('scanners','kids','country')
         )
      or (i_category in ('Books','Women','Sports') and
          i_class in ('science','fragrances','outdoor') 
        ))
...
-- end query 12 in stream 4 using template query89.tpl
-- start query 13 in stream 4 using template query91.tpl
select  
...
-- end query 13 in stream 4 using template query91.tpl
-- start query 14 in stream 4 using template query14.tpl
with  cross_items as
...
-- end query 14 in stream 4 using template query14.tpl
-- start query 15 in stream 4 using template query46.tpl
...
-- end query 15 in stream 4 using template query46.tpl
-- start query 16 in stream 4 using template query58.tpl
with ss_items as
...
-- end query 16 in stream 4 using template query58.tpl
-- start query 17 in stream 4 using template query48.tpl
select sum (ss_quantity)
 ...
 or
  ...
  ca_country = 'United States'
  and
  ca_state in ('IL', 'AK', 'NC')
  and ss_net_profit between 50 and 25000 
  )
 )
;

-- end query 17 in stream 4 using template query48.tpl
-- start query 18 in stream 4 using template query59.tpl
with wss as 
 (select d_week_seq,
        ss_store_sk,
...
-- end query 18 in stream 4 using template query59.tpl
-- start query 19 in stream 4 using template query2.tpl
with wscs as
 (select sold_date_sk
        ,sales_price
...
-- end query 19 in stream 4 using template query2.tpl
-- start query 20 in stream 4 using template query83.tpl
with sr_items as
 (select i_item_id item_id,
...
-- end query 20 in stream 4 using template query83.tpl
...
select top 100 *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (dateadd(day, -30, cast ('2001-04-17' as date)))
                    and (dateadd(day, +30, cast ('2001-04-17' as date)))
...
-- end query 21 in stream 4 using template query21.tpl
-- start query 22 in stream 4 using template query78.tpl
with ws as
...
-- end query 22 in stream 4 using template query78.tpl
-- start query 23 in stream 4 using template query40.tpl
select top 100 
   w_state
  ,i_item_id
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (dateadd(day, -30, cast ('1999-02-24' as date)))
                and (dateadd(day, +30, cast ('1999-02-24' as date))) 
 group by
    w_state,i_item_id
 order by w_state,i_item_id
;

-- end query 23 in stream 4 using template query40.tpl
-- start query 24 in stream 4 using template query99.tpl
select top 100 
...
-- end query 24 in stream 4 using template query99.tpl
-- start query 25 in stream 4 using template query19.tpl
...
-- end query 25 in stream 4 using template query19.tpl
-- start query 26 in stream 4 using template query72.tpl
...
-- end query 26 in stream 4 using template query72.tpl
-- start query 27 in stream 4 using template query6.tpl
...
-- end query 27 in stream 4 using template query6.tpl
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 104 and 104+10
          or ss_coupon_amt between 7850 and 7850+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 180 and 180+10
          or ss_coupon_amt between 8303 and 8303+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 93 and 93+10
          or ss_coupon_amt between 10065 and 10065+1000
...
-- start query 29 in stream 4 using template query81.tpl
...
-- end query 29 in stream 4 using template query81.tpl
-- start query 30 in stream 4 using template query44.tpl
...
-- end query 30 in stream 4 using template query44.tpl
-- start query 31 in stream 4 using template query97.tpl
with ssci as (
...
-- end query 31 in stream 4 using template query97.tpl
-- start query 32 in stream 4 using template query88.tpl
select  *
from
...
-- end query 32 in stream 4 using template query88.tpl
-- start query 33 in stream 4 using template query77.tpl
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-09' as date) 
                  and (dateadd(day, +30, cast('2002-08-09' as date))) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
-- end query 33 in stream 4 using template query77.tpl
-- start query 34 in stream 4 using template query95.tpl
with ws_wh as
...
-- end query 34 in stream 4 using template query95.tpl
-- start query 35 in stream 4 using template query33.tpl
with ss as (
 select
...
-- end query 35 in stream 4 using template query33.tpl
-- start query 36 in stream 4 using template query36.tpl
select top 100 * from (
 select
...
-- end query 36 in stream 4 using template query36.tpl
-- start query 37 in stream 4 using template query61.tpl
...
-- end query 37 in stream 4 using template query61.tpl
-- start query 38 in stream 4 using template query35.tpl
select top 100  
  ca_state,
  cd_gender,
  cd_marital_status,
...
-- end query 38 in stream 4 using template query35.tpl
-- start query 39 in stream 4 using template query60.tpl
with ss as (
 select
...
-- end query 39 in stream 4 using template query60.tpl
-- start query 40 in stream 4 using template query75.tpl
WITH all_sales AS (
 SELECT d_year
       ,i_brand_id
       ,i_class_id
...
-- end query 40 in stream 4 using template query75.tpl
-- start query 41 in stream 4 using template query74.tpl
with year_total as (
...
-- end query 41 in stream 4 using template query74.tpl
-- start query 42 in stream 4 using template query55.tpl
...
-- end query 42 in stream 4 using template query55.tpl
-- start query 43 in stream 4 using template query51.tpl
WITH web_v1 as (
select
...
-- end query 43 in stream 4 using template query51.tpl
-- start query 44 in stream 4 using template query17.tpl
...
-- end query 44 in stream 4 using template query17.tpl
-- start query 45 in stream 4 using template query52.tpl
...
-- end query 45 in stream 4 using template query52.tpl
-- start query 46 in stream 4 using template query90.tpl
...
-- end query 46 in stream 4 using template query90.tpl
-- start query 47 in stream 4 using template query22.tpl
select top 100 i_product_name
             ,i_brand
             ,i_class
             ,i_category
...
-- end query 47 in stream 4 using template query22.tpl
-- start query 48 in stream 4 using template query27.tpl
select top 100 i_item_id,
...
-- end query 48 in stream 4 using template query27.tpl
-- start query 49 in stream 4 using template query63.tpl
select top 100 * 
...
-- end query 49 in stream 4 using template query63.tpl
-- start query 50 in stream 4 using template query38.tpl
...
-- end query 50 in stream 4 using template query38.tpl
-- start query 51 in stream 4 using template query18.tpl
select top 100 i_item_id,
        ca_country,
        ca_state, 
        ca_county,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (12,9,6,4,10,11) and
       d_year = 2001 and
       ca_state in ('GA','PA','KS'
                   ,'MO','OR','AZ','CA')
...
-- end query 51 in stream 4 using template query18.tpl
-- start query 52 in stream 4 using template query24.tpl
with ssales as
(select c_last_name
      ,c_first_name
      ,s_store_name
...
-- start query 53 in stream 4 using template query37.tpl
select top 100 i_item_id
       ,i_item_desc
       ,i_current_price
 ...
 and d_date between cast('1998-05-04' as date) and (dateadd(day, +60, cast('1998-05-04' as date)))
...
-- start query 54 in stream 4 using template query47.tpl
with v1 as(
...
-- end query 54 in stream 4 using template query47.tpl
-- start query 55 in stream 4 using template query10.tpl
select top 100 
  cd_gender,
  cd_marital_status,
  cd_education_status,
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Miami County','Butte County','New Haven County','Richmond County','Bear Lake County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
-- end query 55 in stream 4 using template query10.tpl
-- start query 56 in stream 4 using template query70.tpl
select top 100 * from (
 select 
...
-- end query 56 in stream 4 using template query70.tpl
-- start query 57 in stream 4 using template query23.tpl
...
-- end query 57 in stream 4 using template query23.tpl
-- start query 58 in stream 4 using template query7.tpl
select top 100 i_item_id, 
        avg(ss_quantity) agg1,
        avg(ss_list_price) agg2,
        avg(ss_coupon_amt) agg3,
...
-- end query 58 in stream 4 using template query7.tpl
-- start query 59 in stream 4 using template query92.tpl
select top 100 
...
and d_date between '1999-01-28' and 
        (dateadd(day, +90, cast('1999-01-28' as date)))
...
-- end query 59 in stream 4 using template query92.tpl
-- start query 60 in stream 4 using template query54.tpl
...
-- end query 60 in stream 4 using template query54.tpl
-- start query 61 in stream 4 using template query82.tpl
select top 100 i_item_id
       ,i_item_desc
       ,i_current_price
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-01-06' as date) and (dateadd(day, +60, cast('2001-01-06' as date)))
...
-- start query 62 in stream 4 using template query76.tpl
...
-- end query 62 in stream 4 using template query76.tpl
-- start query 63 in stream 4 using template query80.tpl
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-18' as date) 
                  and (dateadd(day, +30, cast('2002-08-18' as date)))
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
-- end query 63 in stream 4 using template query80.tpl
-- start query 64 in stream 4 using template query56.tpl
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('thistle','sky','hot'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 2
...
-- end query 64 in stream 4 using template query56.tpl
-- start query 65 in stream 4 using template query96.tpl
...
-- end query 65 in stream 4 using template query96.tpl
-- start query 66 in stream 4 using template query50.tpl
select top 100 
   s_store_name
  ,s_company_id
  ,s_street_number
...
-- end query 66 in stream 4 using template query50.tpl
-- start query 67 in stream 4 using template query85.tpl
...
-- end query 67 in stream 4 using template query85.tpl
-- start query 68 in stream 4 using template query86.tpl
select top 100 * from (
 select 
...
-- end query 69 in stream 4 using template query69.tpl
-- start query 70 in stream 4 using template query68.tpl
select top 100 c_last_name
       ,c_first_name
       ,ca_city
       ,bought_city
...
-- end query 70 in stream 4 using template query68.tpl
-- start query 71 in stream 4 using template query1.tpl
with customer_total_return as
...
-- end query 71 in stream 4 using template query1.tpl
-- start query 72 in stream 4 using template query12.tpl
select top 100 i_item_id
      ,i_item_desc 
      ,i_category 
      ,i_class 
...
where 
	...
	and d_date between cast('2001-06-21' as date) 
				and (dateadd(day, +30, cast('2001-06-21' as date)))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
-- end query 72 in stream 4 using template query12.tpl
-- start query 73 in stream 4 using template query43.tpl
...
-- end query 73 in stream 4 using template query43.tpl
-- start query 74 in stream 4 using template query16.tpl
select top 100 
...
-- end query 74 in stream 4 using template query16.tpl
-- start query 75 in stream 4 using template query4.tpl
with year_total as (
 select c_customer_id customer_id
       ,c_first_name customer_first_name
       ,c_last_name customer_last_name
...
-- end query 75 in stream 4 using template query4.tpl
-- start query 76 in stream 4 using template query25.tpl
select top 100 
 i_item_id
 ,i_item_desc
 ,s_store_id
...
-- end query 76 in stream 4 using template query25.tpl
-- start query 77 in stream 4 using template query20.tpl
select top 100 i_item_id
       ,i_item_desc 
       ,i_category 
       ,i_class 
 ...
 and d_date between cast('1999-05-03' as date) 
 				and (dateadd(day, +30, cast('1999-05-03' as date)))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
-- end query 77 in stream 4 using template query20.tpl
-- start query 78 in stream 4 using template query65.tpl
select top 100
	s_store_name,
	i_item_desc,
	sc.revenue,
...
-- end query 78 in stream 4 using template query65.tpl
-- start query 79 in stream 4 using template query15.tpl
...
-- end query 79 in stream 4 using template query15.tpl
-- start query 80 in stream 4 using template query98.tpl
select i_item_id
      ,i_item_desc 
      ,i_category 
      ,i_class 
...
where 
	...
	and d_date between cast('1998-02-12' as date) 
				and (dateadd(day, +30, cast('1998-02-12' as date)))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
-- end query 80 in stream 4 using template query98.tpl
-- start query 81 in stream 4 using template query42.tpl
select top 100 dt.d_year
 	,item.i_category_id
 	,item.i_category
...
-- end query 81 in stream 4 using template query42.tpl
-- start query 82 in stream 4 using template query26.tpl
select top 100 i_item_id, 
...
-- end query 82 in stream 4 using template query26.tpl
-- start query 83 in stream 4 using template query34.tpl
select c_last_name
       ,c_first_name
       ,c_salutation
       ,c_preferred_cust_flag
...
-- end query 83 in stream 4 using template query34.tpl
-- start query 84 in stream 4 using template query5.tpl
with ssr as
 (select s_store_id,
 ...
 where date_sk = d_date_sk
       and d_date between cast('1999-08-16' as date) 
                  and (dateadd(day, +14, cast('1999-08-16' as date)))
...
-- end query 84 in stream 4 using template query5.tpl
-- start query 85 in stream 4 using template query87.tpl
select count(*) 
...
-- end query 85 in stream 4 using template query87.tpl
-- start query 86 in stream 4 using template query3.tpl
select top 100 dt.d_year 
       ,item.i_brand_id brand_id 
       ,item.i_brand brand
...
-- end query 86 in stream 4 using template query3.tpl
-- start query 87 in stream 4 using template query64.tpl
with cs_ui as
 (select cs_item_sk
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('dodger','lace','ghost','puff','lemon','thistle') and
...
-- end query 87 in stream 4 using template query64.tpl
-- start query 88 in stream 4 using template query31.tpl
with ss as
...
-- end query 88 in stream 4 using template query31.tpl
-- start query 89 in stream 4 using template query57.tpl
with v1 as(
 select i_category, i_brand,
        cc_name,
        d_year, d_moy,
...
-- end query 89 in stream 4 using template query57.tpl
-- start query 90 in stream 4 using template query30.tpl
with customer_total_return as
...
-- end query 90 in stream 4 using template query30.tpl
-- start query 91 in stream 4 using template query13.tpl
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('KS', 'LA', 'SD')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('PA', 'TX', 'OH')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('IA', 'MN', 'AL')
  and ss_net_profit between 50 and 250  
     ))
;

-- end query 91 in stream 4 using template query13.tpl
-- start query 92 in stream 4 using template query94.tpl
select top 100 
   count(distinct ws_order_number) as "order count"
  ,sum(ws_ext_ship_cost) as "total shipping cost"
  ,sum(ws_net_profit) as "total net profit"
...
-- end query 92 in stream 4 using template query94.tpl
-- start query 93 in stream 4 using template query62.tpl
select top 100 
   substring(w_warehouse_name,1,20)
  ,sm_type
  ,web_name
...
-- end query 93 in stream 4 using template query62.tpl
-- start query 94 in stream 4 using template query49.tpl
...
-- end query 94 in stream 4 using template query49.tpl
-- start query 95 in stream 4 using template query11.tpl
with year_total as (
 select c_customer_id customer_id
       ,c_first_name customer_first_name
       ,c_last_name customer_last_name
...
-- end query 95 in stream 4 using template query11.tpl
-- start query 96 in stream 4 using template query73.tpl
select c_last_name
       ,c_first_name
       ,c_salutation
       ,c_preferred_cust_flag 
...
-- end query 96 in stream 4 using template query73.tpl
-- start query 97 in stream 4 using template query67.tpl
select top 100 *
...
-- end query 97 in stream 4 using template query67.tpl
-- start query 98 in stream 4 using template query53.tpl
select top 100 * from 
...
-- end query 98 in stream 4 using template query53.tpl
-- start query 99 in stream 4 using template query9.tpl
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 19420
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 2206
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 36217
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 26845
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 10119
            then (select avg(ss_ext_sales_price)
                  from store_sales
