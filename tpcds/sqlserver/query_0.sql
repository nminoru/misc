...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-19' as date) 
                  and (dateadd(day, +14, cast('2000-08-19' as date)))
...
where 
	...
	and d_date between cast('2001-06-15' as date) 
				and (dateadd(day, +30, cast('2001-06-15' as date)))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select top 100 i_item_id
 ...
 and d_date between cast('2002-06-18' as date) 
 				and (dateadd(day, +30, cast('2002-06-18' as date)))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select top 100 *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (dateadd(day, -30, cast ('1999-06-22' as date)))
                    and (dateadd(day, +30, cast ('1999-06-22' as date)))
...
and d_date between '2001-03-09' and 
        (dateadd(day, +90, cast('2001-03-09' as date)))
...
select top 100 i_item_id
 ...
 and d_date between cast('2002-03-29' as date) and (dateadd(day, +60, cast('2002-03-29' as date)))
...
select top 100 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (dateadd(day, -30, cast ('2001-05-02' as date)))
                and (dateadd(day, +30, cast ('2001-05-02' as date))) 
 group by
    w_state,i_item_id
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-10' as date) 
                  and (dateadd(day, +30, cast('2000-08-10' as date))) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-14' as date) 
                  and (dateadd(day, +30, cast('2002-08-14' as date)))
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select top 100 i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-01-13' as date) and (dateadd(day, +60, cast('2001-01-13' as date)))
...
and d_date between '2000-02-01' and 
        (dateadd(day, +90, cast('2000-02-01' as date)))
...
where 
	...
	and d_date between cast('1999-02-05' as date) 
				and (dateadd(day, +30, cast('1999-02-05' as date)))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
